use crate::{
    ...
    AggregateVerifier, DecodeError, HashedMessage, InvalidProofError, PreparedMessage,
    ProofOfPossession, ProofVerificationError, PublicKey, PublicKeyAggregationError, Signature,
...
const _: fn() = || {
    ...
    assert_send_sync::<PublicKeyAggregationError>();
    ...
    assert_send_sync::<UnprovenPublicKey>();
};
...
const _: fn() = || {
    ...
    assert_send_sync::<SecretKeyDecodeError>();
};
